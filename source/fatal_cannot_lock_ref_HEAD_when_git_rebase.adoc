...
[source,bash,data-user="user",data-host="local",data-output="2-4"]
----
...
[.no-line-numbers.command-line]
[source,bash,data-user="user",data-host="local",data-output="2-3, 5"]
----
ls .git/refs/heads/
akiakishitai/  master
...
.空ディレクトリ削除で成功
[.no-line-numbers.command-line]
[source,bash,data-user="user",data-host="local",data-output="3-7"]
----
